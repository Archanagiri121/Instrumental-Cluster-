...
Item {
    ...
    property bool ifSimulatedSpeed: mainController.vehicleMetrics.simulationRunning
    ...
    Rectangle {
        ...
        Canvas {
            ...
            onPaint: {
                ...
                gradient.addColorStop(0.0, Styles.speedLow)
                gradient.addColorStop(0.3, Styles.speedMid)
                gradient.addColorStop(0.8, Styles.speedHigh)
        ...
        Shape {
            ...
            ShapePath {
                strokeColor: Styles.speedStrokeColor
                strokeWidth: strokeWidthSize + 2
                fillColor: Styles.appTranslucentColor
