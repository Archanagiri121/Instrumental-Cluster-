...
Item {
        ...
        RowLayout {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    Layout.preferredHeight: constValue
                    radius: constValue
                    color: index === currentIndex ? Styles.appTextColor : Styles.appMenuTextColor
                    MouseArea {
                        anchors.fill: parent
        ...
        Popup {
            ...
            background: Rectangle {
                ...
                Rectangle {
                    ...
                    radius: constValue
                    color: currentIndex === 0 ? Styles.menuSlideLeft : currentIndex
                                                === 1 ? Styles.menuSlideMid : Styles.menuSlideRight
    ...
    function resetIconScaling() {
        for (var i = 0; i < dotRepeater.count; i++) {
            dotRepeater.itemAt(i).color
                    = (i === currentIndex) ? Styles.appTextColor : Styles.appMenuTextColor
        }
        updateSlidingHighlight()
    }
    ...
    function updateSlidingHighlight() {
        ...
        slidingHighlightRectangle.color = currentIndex
                === 0 ? Styles.menuSlideLeft : currentIndex
                        === 1 ? Styles.menuSlideMid : currentIndex
                                === 2 ? Styles.menuSlideRight : slidingHighlightRectangle.color
    }
}
